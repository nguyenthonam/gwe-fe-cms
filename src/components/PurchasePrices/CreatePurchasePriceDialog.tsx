...
export default function CreatePurchasePriceDialog({ open, onClose, onCreated }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showNotification("Tạo giá mua thành công", "success");
      onCreated();
    } catch (err: any) {
      showNotification(err.message || "Lỗi tạo giá mua", "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      <DialogTitle>Tạo giá mua</DialogTitle>
      <DialogContent>
